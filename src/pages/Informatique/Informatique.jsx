    ...
    <div className="container">
      <div className="div_container">
        ...
        <div className="video-content" aria-live="polite">
          <p>
            Chez AMServices, nous vous proposons une sélection de matériel informatique, en partenariat avec de grande marques
          </p>
        </div>
      </div>
      ...
      <section id='infogerance' className="infogerance">
        <Infogerance openTarifs={openTarifs} setOpenTarifs={setOpenTarifs} />
      </section>

      <section id="infrastructure" className="infrastructure">
        <Infrastructure openTarifs={openTarifs} />
      </section>
    </div>
  );
};
